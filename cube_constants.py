...
CUSTOM_HELP = ('configures the cube with a valid string of ' +
			   str(SQUARES_ON_A_CUBE) + ' colour characters.')
TEXT_HELP = 'displays the current cube configuration in text format.'

COMMAND_PAIRS = {(HANDS_OP, HANDS_HELP), (JUMBLE_OP, JUMBLE_HELP), 
				 (SOLVE_OP, SOLVE_HELP), (TEXT_OP, TEXT_HELP), 
